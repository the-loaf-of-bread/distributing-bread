...
Another thing, an Islamic way of thinking. If posed with anything problematic, one mustn't be quick to dismiss that by things such as 'oh no the ahadith are very untrustworthy'. One must seek to find the answers. For instance one might come across an eyes-branded claim online. It would be unwise to see that and just reject ahadith in one go. A little digging deeper with a pure intention to seek the truth from credible Islamic sources, however, reveals that it was done as part of Qisas. In this day and age, many people have come to believe that their own judgement and values based upon various "isms" are superior to Islam and thus they do not find it difficult to simply say "no" to an Islamic injunction. Which is problematic.

For this purpose, section 2, on incentives, matters a lot. There is a verse in the Qur'an stating that the Prophet PBUH was sent as a witness (section 1: witness the veracity of Islam), as a bearer of glad tidings and a warner (section 2: incentives)... section 2 will InshaAllah begin by stating that the main reason why we obey Islamic teachings aren't because of their worldly benefits to us, it's because of the fact that we were commanded by Allah to do so. However this isn't counterintuitive in any way, since Allah knows His creation better than they themselves know, and thus His commands are "meant" for us... and thus their benefits r manyyy. So yes, we obey Allah's commands, and as a useful byproduct we get good deeds for the afterlife + worldly benefits too. Then later in section 2, describe heaven and hell in vivid detail based upon Sahih ahadith. 
